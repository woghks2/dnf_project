...
jobs_dict = {
    ...
    "1_1": "여넨마스터", "1_2": "여스트라이커", "1_3": "여스트리트파이터", "1_4": "여그래플러",  # 격투가(여)
    "2_1": "남레인저", "2_2": "남런처", "2_3": "남메카닉", "2_4": "남스핏파이어", "2_5": "어썰트",  # 거너(남)
    "5_1": "여레인저", "5_2": "여런처", "5_3": "여메카닉", "5_4": "여스핏파이어",  # 거너(여)
    "8_1": "엘레멘탈 바머", "8_2": "빙결사", "8_3": "블러드 메이지", "8_4": "스위프트 마스터", "8_5": "디멘션워커",  # 마법사(남)
    "3_1": "엘레멘탈 마스터", "3_2": "소환사", "3_3": "배틀메이지", "3_4": "마도학자", "3_5": "인챈트리스",  # 마법사(여)
    "4_1": "남크루세이더", "4_2": "인파이터", "4_3": "퇴마사", "4_4": "어벤저",  # 프리스트(남)
    "14_1": "여크루세이더", "14_2": "이단심판관", "14_3": "무녀", "14_4": "미스트리스",  # 프리스트(여)
    "6_1": "로그", "6_2": "사령술사", "6_3": "쿠노이치", "6_4": "섀도우댄서",  # 도적
    "12_1": "엘븐나이트", "12_2": "카오스", "12_3": "팔라딘", "12_4": "드래곤나이트",  # 나이트
    "13_1": "뱅가드", "13_2": "듀얼리스트", "13_3": "드래고니안 랜서", "13_4": "다크 랜서",  # 마창사
    "15_1": "히트맨", "15_2": "요원", "15_3": "트러블 슈터", "15_4": "스페셜리스트",  # 총검사
    "16_1": "뮤즈", "16_2": "트래블러",  # 아처
    "9_0": "다크나이트",  # 다크나이트
    "10_0": "크리에이터"  # 크리에이터
}
...
def scrape_characters(driver, job_name: str):
    ...
    for character in characters:
        ...
        row = {'sv_kor': sv_kor, 'sv_eng': sv_eng,
               ...
               'lv': int(lv[3:]), 'fame': int(fame.replace(",", ""))}
        data.append(row)
